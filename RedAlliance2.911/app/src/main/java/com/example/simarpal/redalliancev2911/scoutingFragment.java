...
public class scoutingFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        RelativeLayout parent = (RelativeLayout) getView().findViewById(R.id.RelativeLayout);
    ...
    private void writerToFileScouting() throws IOException {
        ...
        File outDir = new File(root.getAbsolutePath().toString() + File.separator + "Red Alliance" + File.separator + "Scouting" + File.separator + teamNumberDouble.toString());
        outDir.mkdirs();
        Writer writer;
        Log.i("INFO",outDir.toString());
