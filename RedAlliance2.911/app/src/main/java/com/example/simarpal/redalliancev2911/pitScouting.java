...
public class pitScouting extends Fragment {
   ...
   Switch pitHerdLitterBool;
    ...
    private File createImageFile() throws IOException {
        ...
        File outDir = new File(root.getAbsolutePath() + File.separator + "Red Alliance" + File.separator + "Images");
            outDir.mkdirs();
        ...
        if (takePictureIntent.resolveActivity(getActivity().getPackageManager()) != null) {
            ...
            if (takePictureIntent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                try {
                    ...
                    Log.e("ERROR","Image file not created ERROR");
                }
                if (photoFile != null) {
                    takePictureIntent.putExtra(MediaStore.EXTRA_OUTPUT,
                            Uri.fromFile(photoFile));
                }
                Bitmap robotPiture = BitmapFactory.decodeFile(photoFile.getAbsolutePath());
                imageView.setImageBitmap(robotPiture);
            }
    ...
    private void writerToFilePit() throws IOException {
        ...
        File root = Environment.getExternalStorageDirectory();
        File outDir = new File(root.getAbsolutePath() + File.separator + "Red Alliance" + File.separator + "Pit Scouting");
        Writer writer;
